<a href="{{ $url }}"
   class="flex items-center justify-between w-full md:w-auto mb-[20px] md:mb-[0] bg-white p-[24px] rounded-[20px] group hover:bg-[var(--color-main)] transition-all duration-300 md:mr-[20px]">
