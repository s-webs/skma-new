    ...
    <div class="h-auto xl:h-[840px] bg-custom-main relative">
        ...
        <div class="px-1 xs:px-2 xl:container flex items-center justify-center h-full mx-auto pt-[50px] xl:pt-[0px]">
            <div class="flex flex-col xl:flex-row items-center relative z-[5]">
                ...
                <div class="bg-white -translate-y-[50px] xl:-translate-y-[0px] xl:-translate-x-[55px] p-[40px] xl:w-[850px] h-auto xl:h-[410px] rounded-[30px] relative"
                    ...
                    <div class="h-[114px] mt-[20px] xl:mt-[40px] relative z-[5] overflow-y-auto pr-[8px]">
                        <p class="text-[14px] md:text-[24px] text-custom-heading" x-text="reviews[currentIndex].message"></p>
                    </div>
