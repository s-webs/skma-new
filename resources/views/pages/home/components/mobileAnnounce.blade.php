<div class="bg-[var(--color-halftone)] xl:hidden pt-[44px] pb-[44px] md:pb-[64px] md:pt-[64px] px-2"
     x-data="{ slideIndex: 0, slides: {{ json_encode($announcements) }} }">
    <div
        class="relative border-[5px] w-full h-[300px] md:h-[450px] border-inside border-[var(--color-primary)] rounded-[20px] overflow-hidden">
        ...
        <div class="w-full">
            <div x-transition:enter="transition ease-in-out duration-300"
                ...
                <div class="flex items-center justify-between mt-[16px]">
                    <div class="text-[14px]">
                        <span class="py-[7px] px-[10px] bg-[var(--color-primary)] text-[var(--color-main)] font-bold rounded-[10px]">{{ __('home.announce') }}</span>
                    </div>
                    <div class="flex items-center">
                        <button @click="slideIndex = (slideIndex - 1 + slides.length) % slides.length"
                                class="border flex justify-center items-center border-[#E2E2E2] w-[35px] h-[35px] rounded-full text-[16px] text-[var(--color-main)] hover:text-[var(--color-halftone)] mr-[12px] hover:bg-[var(--color-main)] transition-colors duration-300">
                ...
                <div class="mt-[16px] text-[16px] text-[var(--color-secondary)] leading-[23px]">
                ...
                <div class="mt-[24px]" x-show="slides[slideIndex].link">
                    <div class="">
                        <a :href="slides[slideIndex].link"
                           class="px-[15px] py-[10px] bg-[var(--color-main)] rounded-full text-white font-semibold">{{ __('home.detail') }}</a>
                    </div>
                </div>
            </div>
        </div>
