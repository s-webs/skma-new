<div class="bg-white">
    <div class="container mx-auto px-2 xl:px-[44px] py-[50px] lg:py-[100px]">
        ...
        <div class="flex flex-wrap items-center justify-between mt-[30px] xl:mt-[60px]">
            @foreach($awards as $item)
                <div class="my-[16px] md:my-[15px] w-full md:w-[48%] xl:w-[400px] xl:h-[282.75px] xl:my-[0px]">
