<div class="relative bg-summer-main 2xl:h-[355px] overflow-hidden">
    <img src="/assets/images/cliparts/summer_01.png" alt="" class="absolute w-full h-full object-cover z-[3] opacity-20">
            ...
            <div class="py-[16px] md:py-[0px]">
                ...
                <div class="mt-[16px] md:mt-[32px] 2xl:mt-[64px]">
                    <a href="{{ route('applicant.index') }}"
                       class="px-[16px] md:px-[31px] py-[8px] md:py-[21px] bg-white hover:bg-summer-main text-[12px] md:text-[18px] font-semibold text-summer-main hover:text-white transition-all duration-300 rounded-full">{{ __('home.detail') }}</a>
                </div>
            </div>
