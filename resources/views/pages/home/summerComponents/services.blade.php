                    ...
                    <div class="swiper-wrapper">
                        @foreach($services as $item)
                            <div class="swiper-slide w-[400px] max-h-[300px] rounded-[20px] overflow-hidden relative group transition-all duration-300">
                                ...
                                <div
                                    class="absolute bottom-[0] left-[0] w-full h-[120px] group-hover:h-[180px] bg-gradient-to-t from-summer-main to-white/0 transition-all duration-300 z-[3]">
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        @foreach($services as $item)
                            <div class="swiper-slide w-[400px] max-h-[200px] rounded-[20px] overflow-hidden relative">
                                ...
                                <div
                                    class="absolute bottom-[0] left-[0] w-full h-[120px] bg-gradient-to-t from-summer-main to-white/0">
                                </div>
                            </div>
                        @endforeach
                    </div>
