    ...
    <div class="container mx-auto px-2 xl:px-[44px] py-[50px] lg:py-[100px]">
        <div class="flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="hidden md:block">
                <a href="{{ route('ads.index') }}"
                   class="relative flex justify-between items-center mt-[20px] md:mt-[0px] bg-winter-main rounded-full overflow-hidden group transition-all duration-300 hover:shadow-lg hover:scale-105">
                    <div
        ...
        <div class="flex flex-col lg:flex-row items-start mt-[30px] md:mt-[60px]">
            @foreach($adverts as $item)
                <div
                    class="bg-white hover:bg-winter-main group transition-colors duration-300 p-[20px] rounded-[20px] w-full lg:w-1/3 lg:mx-[5px] text-[14px] my-[8px] lg-my-[0px]">
                    <div class="flex items-center mb-[10px]">
                        <i class="fad fa-calendar-alt text-winter-main mr-[8px] group-hover:text-white"></i>
