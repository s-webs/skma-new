<div class="relative bg-custom-main 2xl:h-[355px] overflow-hidden">
    <img src="/assets/images/cliparts/spring_01.png" alt="" class="absolute w-full h-full object-cover z-[3] opacity-20">
