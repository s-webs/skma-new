...
@section('content')
    <div class="w-full py-[60px] h-auto xl:h-[600px] 2xl:h-[700px] overflow-hidden relative">
        <div class="w-full h-full absolute top-0 left-0 bg-custom-main">
            ...
            <div class="w-full h-full bg-custom-main/40 absolute top-0 left-0 z-[4]"></div>
        </div>
            ...
            <div class="container mx-auto px-4">
                <div class="w-full">
                    ...
                    <div class="flex flex-wrap xl:flex-nowrap items-center w-full mt-[40px]">
                            <x-link-card url="/assets/files/price-bakalavr-2025.pdf" title="{{ __('applicant.education_and_accommodation') }}" subtitle="{{ __('applicant.price_list') }}" />
                            <x-link-card url="/assets/files/pravila-priema-bakalavr-2025.pdf" title="{{ __('applicant.admission_rules_for_training') }}" subtitle="{{ __('applicant.bakalavriat') }}" />
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="bg-custom-main overflow-hidden mt-[60px]">
        <div class="py-[60px] flex flex-wrap items-center justify-center relative">
            ...
            @foreach($counters as $counter)
                <div class="w-[160px] h-[160px] xl:w-[250px] xl:h-[250px] m-[14px] rounded-full flex flex-col justify-center items-center text-center p-5 text-white bg-[#914EFF] border-[5px] xl:border-[20px] border-[#9757FF]">
    ...
    <div class="my-[60px]">
        <div class="container mx-auto px-4">
            <div x-data="{ open: false }" class="overflow-hidden bg-white rounded-[15px] box-border">
                <h3 @click="open = !open" class="cursor-pointer flex justify-between items-center bg-custom-main py-[16px] px-[24px] rounded-[15px] text-white shadow-md font-semibold">
