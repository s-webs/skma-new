...
@section('content')
    ...
    <div class="bg-custom-main overflow-hidden mt-[60px]">
        <div class="py-[60px] flex flex-wrap items-center justify-center relative">
            <div class="absolute hidden md:block left-[3%] uxl:left-[25%] bottom-[0px] z-[3]">
                <img src="/assets/images/cliparts/spring_01.png" alt="" class="w-full h-full object-cover opacity-20">
            </div>
