@extends('layouts.winterLayout', ['kzLink' => 'for-the-applicant/', 'ruLink' => 'for-the-applicant/', 'enLink' => 'for-the-applicant/'])
...
@section('content')
    ...
    <div class="bg-winter-main overflow-hidden mt-[60px]">
        <div class="py-[60px] flex flex-wrap items-center justify-center relative">
            <div class="absolute left-[0] top-[0] w-full h-full">
                <img src="/assets/images/cliparts/winter_01.png" alt="" class="w-full h-full object-cover opacity-20 z-[3]">
            </div>
    ...
    <div class="my-[60px]">
        <div class="container mx-auto px-4">
            <div x-data="{ open: false }" class="overflow-hidden bg-white rounded-[15px] box-border">
                <h3 @click="open = !open" class="cursor-pointer flex justify-between items-center bg-winter-main py-[16px] px-[24px] rounded-[15px] text-white shadow-md font-semibold">
