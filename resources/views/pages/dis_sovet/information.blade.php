@extends('layouts.public', ['kzLink' => 'dis-sovet/information/', 'ruLink' => 'dis-sovet/information/', 'enLink' => 'dis-sovet/information/'])
    ...
    <div class="container mx-auto px-4 mb-[60px]">
        <div class="mt-[40px] md:mt-[60px] xl:mt-[40px]">
            <x-breadcrumbs :items="[
                ...
                ['title' => __('dissovet.information_for_applicants'), 'url' => route('dissovet.documents')],
            ]"/>
        </div>
        <div class="mt-[60px] pb-[50px] py-[20px] xl:pb-[100px] bg-white shadow-md rounded-[15px] px-4 2xl:px-28">
            <div>
                <x-page-title>{{ __('dissovet.information_for_applicants') }}</x-page-title>
            </div>
            <div class="mt-[70px]">
