@extends('layouts.winterLayout', ['kzLink' => 'news/' . $item->slug_kz, 'ruLink' => 'news/' . $item->slug_ru, 'enLink' => 'news/' . $item->slug_en])
    ...
    <div>
        <div class="container mx-auto px-4 2xl:px-28 bg-white py-[40px] my-[40px] rounded-[15px] shadow-md">
            ...
            <div
                ...
                <div class="">
                    {{--                    <a href="##"--}}
                    {{--                       class="py-[12px] px-[14px] border bg-white text-winter-main rounded-[10px] hover:bg-winter-main duration-300 transition-all hover:text-white">--}}
                    {{--                        Подразделение--}}
                    {{--                    </a>--}}
                </div>
            ...
            @if($item->images)
                <div
                    class="mt-[40px] w-full h-[300px] xl:h-[600px] rounded-[30px] overflow-hidden border-[10px] border-winter-main/25">
            ...
            @else
                <div
                    class="mt-[40px] w-full xl:w-[70%] mx-auto h-[300px] xl:h-[600px] rounded-[30px] overflow-hidden border-[10px] border-winter-main/25">
            ...
            {{--            <div class="mt-[30px]">--}}
            {{--                <a href="##" class="py-[12px] px-[30px] rounded-full text-winter-main hover:bg-winter-main hover:text-white mr-[10px] duration-300 transition-all">Теги</a>--}}
            {{--                <a href="##" class="py-[12px] px-[30px] rounded-full text-winter-main hover:bg-winter-main hover:text-white mr-[10px] duration-300 transition-all">Теги</a>--}}
            {{--                <a href="##" class="py-[12px] px-[30px] rounded-full text-winter-main hover:bg-winter-main hover:text-white mr-[10px] duration-300 transition-all">Теги</a>--}}
            {{--            </div>--}}
            ...
            <div class="pt-[60px] border-t">
                ...
                <div class="mt-[24px]">
                    <form action="{{ route('comment.store', $item->id) }}" method="post">
                        ...
                        <button type="submit"
                                class="bg-winter-main hover:bg-winter-extra transition-all duration-300 text-white px-[15px] py-[10px] mt-[10px] rounded-[5px]">
                            Опубликовать
                        </button>
                    </form>
                </div>
